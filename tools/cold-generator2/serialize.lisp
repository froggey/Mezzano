...
(defmethod initialize-object ((object sys.int::layout) value image environment)
  (let ((layout-sdef (env:find-structure-definition
    ...
    (setf (object-slot-by-name image environment layout-sdef value 'sys.int::hash)
          (serialize-object (sys.int::layout-hash object) image environment))
    ...
    (setf (object-slot-by-name image environment layout-sdef value 'sys.int::new-instance)
          (serialize-object nil image environment))
    (setf (object-slot-by-name image environment layout-sdef value 'sys.int::compatible)
          (serialize-object (sys.int::layout-compatible object) image environment))))
