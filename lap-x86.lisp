...
(defun parse-r/m (form)
  (cond ((not (consp form))
	...
	((and (= (length form) 2)
	 ...
	 (ecase (first form)
	   (:car (values nil (second form) nil nil -1))
	   (:cdr (values nil (second form) nil nil 7))
	   (:simple-array-header (values nil (second form) nil nil -7))
	   (:symbol-name (values nil (second form) nil nil -2))
	   (:symbol-package (values nil (second form) nil nil 6))
	   (:symbol-value (values nil (second form) nil nil 14))
	   (:symbol-function (values nil (second form) nil nil 22))
	   (:symbol-plist (values nil (second form) nil nil 30))
           (:symbol-flags (values nil (second form) nil nil 38))
           (:array-header-dimensions (values nil (second form) nil nil -3))
           (:array-header-fill-pointer (values nil (second form) nil nil 5))
           (:array-header-info (values nil (second form) nil nil 13))
           (:array-header-storage (values nil (second form) nil nil 21))
           (:std-instance-class (values nil (second form) nil nil -4))
           (:std-instance-slots (values nil (second form) nil nil 4))))
