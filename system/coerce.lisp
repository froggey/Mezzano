...
(defun coerce (object result-type)
  ...
  (cond ((subtypep result-type 'list)
        ...
        ((subtypep result-type 'short-float)
         (float object #.(xshort-float 1.0s0)))
        ...
        ((subtypep result-type '(complex short-float))
         (complex (float (realpart object) #.(xshort-float 1.0s0)) (float (imagpart object) #.(xshort-float 1.0s0))))
    ...
    `(let ((,obj ,object))
       ...
       ,(cond ((subtypep result-type 'list env)
              ...
              ((subtypep result-type 'float)
               `(float ,obj 1.0f0))
              ((subtypep result-type '(complex short-float))
               `(complex (float (realpart ,obj) #.(xshort-float 1.0s0)) (float (imagpart ,obj) #.(xshort-float 1.0s0))))
              ((subtypep result-type '(complex single-float))
