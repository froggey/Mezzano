...
(defun really-raise-undefined-function (args fref)
  (let ((name (function-reference-name fref)))
    (restart-case
        (error 'undefined-function :name name :arguments args)
