...
(defun sys.int::%stihlt () (sys.int::%stihlt))
(defun sys.int::%sti () (sys.int::%sti))
(defun sys.int::%cli () (sys.int::%cli))
(defun sys.int::%hlt () (sys.int::%hlt))
(defun sys.int::%interrupt-state () (sys.int::%interrupt-state))
(defun sys.int::%save-irq-state () (sys.int::%save-irq-state))
(defun sys.int::%restore-irq-state () (sys.int::%restore-irq-state))
...
(defun sys.int::%cr0 () (sys.int::%cr0))
(defun (setf sys.int::%cr0) (value) (setf (sys.int::%cr0) value))
(defun sys.int::%cr2 () (sys.int::%cr2))
(defun (setf sys.int::%cr2) (value) (setf (sys.int::%cr2) value))
(defun sys.int::%cr3 () (sys.int::%cr3))
(defun (setf sys.int::%cr3) (value) (setf (sys.int::%cr3) value))
(defun sys.int::%cr4 () (sys.int::%cr4))
(defun (setf sys.int::%cr4) (value) (setf (sys.int::%cr4) value))
(defun sys.int::%dr0 () (sys.int::%dr0))
(defun (setf sys.int::%dr0) (value) (setf (sys.int::%dr0) value))
(defun sys.int::%dr1 () (sys.int::%dr1))
(defun (setf sys.int::%dr1) (value) (setf (sys.int::%dr1) value))
(defun sys.int::%dr2 () (sys.int::%dr2))
(defun (setf sys.int::%dr2) (value) (setf (sys.int::%dr2) value))
(defun sys.int::%dr3 () (sys.int::%dr3))
(defun (setf sys.int::%dr3) (value) (setf (sys.int::%dr3) value))
(defun sys.int::%dr4 () (sys.int::%dr4))
(defun (setf sys.int::%dr4) (value) (setf (sys.int::%dr4) value))
(defun sys.int::%dr6 () (sys.int::%dr6))
(defun (setf sys.int::%dr6) (value) (setf (sys.int::%dr6) value))
(defun sys.int::%dr7 () (sys.int::%dr7))
(defun (setf sys.int::%dr7) (value) (setf (sys.int::%dr7) value))

(defun sys.int::tsc () (sys.int::tsc))
(defun sys.int::%invlpg (address) (sys.int::%invlpg address))
(defun sys.int::cpu-relax () (sys.int::cpu-relax))
