...
(define-caps-struct-slots
  (0 caps-max-version                         0 nibbles:ub32ref/le)
  ;; v1 caps
  ...
  (1 caps-glsl-level                        264 nibbles:ub32ref/le)
  (1 caps-max-texture-array-layers          268 nibbles:ub32ref/le)
  (1 caps-max-streamout-buffers             272 nibbles:ub32ref/le)
  (1 caps-max-dual-source-render-targets    276 nibbles:ub32ref/le)
  (1 caps-max-render-targets                280 nibbles:ub32ref/le)
  (1 caps-max-samples                       284 nibbles:ub32ref/le)
  (1 caps-prim-mask                         288 nibbles:ub32ref/le)
  (1 caps-max-tbo-size                      292 nibbles:ub32ref/le)
  (1 caps-max-uniform-blocks                296 nibbles:ub32ref/le)
  (1 caps-max-viewports                     300 nibbles:ub32ref/le)
  (1 caps-max-texture-gather-components     304 nibbles:ub32ref/le)
  ;; v2 caps
  (2 caps-min-aliased-point-size            308 nibbles:ieee-single-ref/le)
  (2 caps-max-aliased-point-size            312 nibbles:ieee-single-ref/le)
  (2 caps-min-smooth-point-size             316 nibbles:ieee-single-ref/le)
  (2 caps-max-smooth-point-size             320 nibbles:ieee-single-ref/le)
  (2 caps-min-aliased-line-width            324 nibbles:ieee-single-ref/le)
  (2 caps-max-aliased-line-width            328 nibbles:ieee-single-ref/le)
  (2 caps-min-smooth-line-width             332 nibbles:ieee-single-ref/le)
  (2 caps-max-smooth-line-width             336 nibbles:ieee-single-ref/le)
  (2 caps-max-texture-lod-bias              340 nibbles:ieee-single-ref/le)
  (2 caps-max-geom-output-vertices          344 nibbles:ub32ref/le)
  (2 caps-max-geom-total-output-components  348 nibbles:ub32ref/le)
  (2 caps-max-vertex-outputs                352 nibbles:ub32ref/le)
  (2 caps-max-vertex-attribs                356 nibbles:ub32ref/le)
  (2 caps-max-shader-patch-varyings         360 nibbles:ub32ref/le)
  (2 caps-min-texel-offset                  364 nibbles:sb32ref/le)
  (2 caps-max-texel-offset                  368 nibbles:sb32ref/le)
  (2 caps-min-texture-gather-offset         372 nibbles:sb32ref/le)
  (2 caps-max-texture-gather-offset         376 nibbles:sb32ref/le)
  (2 caps-texture-buffer-offset-alignment   380 nibbles:ub32ref/le)
  (2 caps-uniform-buffer-offset-alignment   384 nibbles:ub32ref/le)
  (2 caps-shader-buffer-offset-alignment    388 nibbles:ub32ref/le)
  (2 caps-capability-bits                   392 nibbles:ub32ref/le)
  (2 caps-sample-locations                  396 (nibbles:ub32ref/le 8 4))
  (2 caps-max-vertex-attrib-stride          428 nibbles:ub32ref/le)
  (2 caps-max-shader-buffer-frag-compute    432 nibbles:ub32ref/le)
  (2 caps-max-shader-buffer-other-stages    436 nibbles:ub32ref/le)
  (2 caps-max-shader-image-frag-compute     440 nibbles:ub32ref/le)
  (2 caps-max-shader-image-other-stages     444 nibbles:ub32ref/le)
  (2 caps-max-image-samples                 448 nibbles:ub32ref/le)
  (2 caps-max-compute-work-group-invocations 452 nibbles:ub32ref/le)
  (2 caps-max-compute-shared-memory-size    456 nibbles:ub32ref/le)
  (2 caps-max-compute-grid-size             460 (nibbles:ub32ref/le 3 4))
  (2 caps-max-compute-block-size            472 (nibbles:ub32ref/le 3 4))
  (2 caps-max-texture-2d-size               484 nibbles:ub32ref/le)
  (2 caps-max-texture-3d-size               488 nibbles:ub32ref/le)
  (2 caps-max-texture-cube-size             492 nibbles:ub32ref/le))
...
(defun vector-push-extend-ub32/le (new-element vector)
  (let ((here (vector-push-extend 0 vector)))
    ...
    (vector-push-extend 0 vector)
    (vector-push-extend 0 vector)
    (setf (nibbles:ub32ref/le vector here) new-element)
    here))
...
(defun vector-push-extend-sb32/le (new-element vector)
  (let ((here (vector-push-extend 0 vector)))
    ...
    (vector-push-extend 0 vector)
    (vector-push-extend 0 vector)
    (setf (nibbles:sb32ref/le vector here) new-element)
    here))
...
(defun vector-push-extend-ub64/le (new-element vector)
  (let ((here (vector-push-extend 0 vector)))
    ...
    (vector-push-extend 0 vector)
    (vector-push-extend 0 vector)
    (setf (nibbles:ub64ref/le vector here) new-element)
    here))
